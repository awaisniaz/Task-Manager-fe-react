 ...
 */ (function (e) {
  ...
  function r(x) {
    ...
    if (z !== P) {
      x[0] = z;
      e: for (var W = 0, G = x.length, qt = G >>> 1; W < qt; ) {
        var hn = 2 * (W + 1) - 1,
          gl = x[hn],
          yn = hn + 1,
          bt = x[yn];
        if (0 > l(gl, z))
          yn < G && 0 > l(bt, gl)
            ? ((x[W] = bt), (x[yn] = z), (W = yn))
            : ((x[W] = gl), (x[hn] = z), (W = hn));
        else if (yn < G && 0 > l(bt, z)) (x[W] = bt), (x[yn] = z), (W = yn);
        else break e;
      }
    }
    return P;
  ...
  function E(x, P) {
    ...
    try {
      ...
      if (m !== null) var qt = !0;
        ...
        var hn = t(c);
        hn !== null && yl(h, hn.startTime - P), (qt = !1);
      }
      return qt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function Jn(e, n) {
  for (Tt[e] = n, e = 0; e < n.length; e++) us.add(n[e]);
}
var We = !(
    typeof window > "u" ||
...
function gs() {
  if (Kn) {
    var e = Kn,
      n = Yn;
    if (((Yn = Kn = null), Ko(e), n)) for (e = 0; e < n.length; e++) Ko(n[e]);
  }
}
function ws(e, n) {
  return e(n);
...
var _s = ye.unstable_scheduleCallback,
  ...
  Ju = ye.unstable_ImmediatePriority,
...
function nf(e, n, t, r, l) {
  switch (n) {
    ...
    case "gotpointercapture":
      return (
        (u = l.pointerId), Mt.set(u, ft(Mt.get(u) || null, e, n, t, r, l)), !0
      );
  }
  return !1;
}
...
function Sr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Zt(t)), n !== null && bu(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function eo(e, n, t, r) {
  if (Dr) {
    var l = fu(e, n, t, r);
    if (l === null) Ml(e, n, r, Ir, t), Go(e, r);
...
var Ir = null;
function fu(e, n, t, r) {
  if (((Ir = null), (e = Zu(r)), (e = Sn(e)), e !== null))
...
var ut = {
  ...
  sf = we(of),
  af = V({}, Gt, { relatedTarget: 0 }),
  Pl = we(af),
  cf = V({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ff = we(cf),
  df = V({}, ut, {
...
var wf = V({}, Gt, {
  ...
  xf = we(Ef),
  Cf = V({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  _f = we(Cf),
  Nf = V({}, tl, {
    deltaX: function (e) {
...
function Bs(e) {
  if (e.propertyName === "value" && rl(It)) {
    var n = [];
    As(n, It, e, Zu(e)), ks(Of, n);
  }
}
function Df(e, n, t) {
  e === "focusin"
    ? (ui(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", Bs))
    : e === "focusout" && ui();
}
function If(e) {
...
function Js(e, n) {
  ...
  if (jr) throw ((e = su), (jr = !1), (su = null), e);
}
function D(e, n) {
  var t = n[gu];
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              h !== null &&
              ((d = h),
              f !== null && ((h = jt(a, f)), h != null && S.push($t(a, h, d)))),
            F)
          )
            break;
          a = a.return;
      ...
      N &&
        (Fs &&
          ...
          (Dn || N !== "onCompositionStart"
            ...
            : ((en = v),
              (no = "value" in en ? en.value : en.textContent),
              (Dn = !0))),
        (C = Fr(c, N)),
        0 < C.length &&
          ((N = new bo(N, e, null, t, v)),
          m.push({ event: N, listeners: C }),
          _ ? (N.data = _) : ((_ = $s(t)), _ !== null && (N.data = _)))),
        (_ = Lf ? Tf(e, t) : Rf(e, t)) &&
          ((c = Fr(c, "onBeforeInput")),
          0 < c.length &&
            ((v = new bo("onBeforeInput", "beforeinput", null, t, v)),
...
function fi(e, n, t, r, l) {
  for (var u = n._reactName, o = []; t !== null && t !== r; ) {
    ...
    i.tag === 5 &&
      ...
      ((i = c),
      l
        ? ((s = jt(t, u)), s != null && o.unshift($t(t, s, i)))
        : l || ((s = jt(t, u)), s != null && o.push($t(t, s, i)))),
      (t = t.return);
  }
...
var yu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Xf =
    typeof queueMicrotask == "function"
      ...
      : typeof pi < "u"
      ? function (e) {
          return pi.resolve(null).then(e).catch(Gf);
        }
      : yu;
function Gf(e) {
  setTimeout(function () {
...
function vn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), _s(Ju, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function na(e, n, t) {
  (Se[ke++] = Ve), (Se[ke++] = Be), (Se[ke++] = Nn), (Nn = e);
  var r = Ve;
  e = Be;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function $l(e) {
  ...
  if (((e = t.interleaved), e !== null)) {
    l = e;
    do (u = l.lane), (A.lanes |= u), (zn |= u), (l = l.next);
    while (l !== e);
...
function sl(e, n, t, r) {
  ...
  (A.flags |= e), (l.memoizedState = Qt(1 | n, t, u, r));
}
function _i(e, n) {
...
function _a(e, n, t) {
  return Pn & 21
    ? (Oe(t, n) || ((t = zs()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function rd(e, n, t) {
  ...
  if (Pa(e)) za(n, l);
    ...
    (t = la(e, n, l, r)),
      t !== null && ((l = oe()), je(t, e, r, l), La(t, n, r));
  }
}
function Pa(e) {
  var n = e.alternate;
...
var Xr = {
  ...
  ld = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        (l.queue = u),
        _i(va.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Qt(9, ma.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (U && t && oo(n), (n.flags |= 1), ue(e, n, r, l), n.child)
  );
}
function Ti(e, n, t, r, l) {
  if (e === null) {
    ...
    return typeof u == "function" &&
      ...
      ? ((n.tag = 15), (n.type = u), ja(e, n, u, r, l))
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (U && r && oo(n), (n.flags |= 1), ue(e, n, t, l), n.child)
  );
}
function Ri(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Nr(e, n), ia(n, t, r), Cu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function ji(e, n, t, r, l) {
  return bn(), so(l), (n.flags |= 256), ue(e, n, t, r), n.child;
}
...
function ad(e, n, t, r, l, u, o) {
  if (t)
    return n.flags & 256
      ? ((n.flags &= -257), (r = Vl(Error(y(422)))), pr(e, n, o, r))
      : n.memoizedState !== null
  ...
  if (((i = (o & e.childLanes) !== 0), ce || i)) {
    if (((r = J), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | o) ? 0 : l),
        l !== 0 &&
          l !== u.retryLane &&
          ((u.retryLane = l), Ke(e, l), je(r, e, l, -1));
    }
    return Lo(), (r = Vl(Error(y(421)))), pr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function fd(e, n, t) {
  ...
  switch ((io(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), Tu(e, n), e === null && Ut(n.stateNode.containerInfo), te(n), null
      );
    case 10:
    ...
    case 17:
      return de(n.type) && $r(), te(n), null;
    case 19:
      if ((I($), (u = n.memoizedState), u === null)) return te(n), null;
...
function md(e, n) {
  ...
  for (vu = { focusedElem: e, selectionRange: t }, Dr = !1, k = n; k !== null; )
...
function Qa(e, n, t) {
  for (var r = (e.mode & 1) !== 0; k !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (k = u)) : Fi(e);
  }
}
function Fi(e) {
  for (; k !== null; ) {
...
function je(e, n, t, r) {
  if (50 < Lt) throw ((Lt = 0), (Iu = null), Error(y(185)));
  Xt(e, t, r),
    (!(R & 2) || e !== J) &&
      (e === J && (!(R & 2) && (cl |= t), X === 4 && be(e, b)),
      pe(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((rt = Q() + 500), ol && vn()));
}
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Xo(t), n === 1))
      e.tag === 0 ? qf(Ai.bind(null, e)) : ea(Ai.bind(null, e)),
        Xf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function qr(e, n) {
  ...
  while (1);
  if ((co(), (R = t), (Gr.current = r), K !== null)) throw Error(y(261));
  return (J = null), (b = 0), X;
}
function gd() {
  for (; K !== null; ) Ga(K);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Cu(n, r, e, t),
            (n = Pu(null, n, r, !0, u, t)))
          : ((n.tag = 0), U && u && oo(n), ue(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
function Ld(e, n, t, r, l) {
  ...
  var s = Ro(e, 0, !1, null, null, !1, !1, "", Hi);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qu(n, t | 1), pe(n, Q()), !(R & 6) && ((rt = Q() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ws = Po;
Ss = Ln;
var Td = { usingClientEntryPoint: !1, Events: [Zt, Un, ul, ys, gs, Po] },
  ht = {
...
function Od() {
  return j.jsxs("div", {
    className:
      "w-full h-14 bg-orange-700 flex justify-between items-center p-3  ",
    children: [
      j.jsx("div", {
      ...
      j.jsx("div", {
        ...
        children: j.jsx("button", {
          className:
            "bg-white  w-36 p-3 rounded flex justify-center items-center",
          children: "Login"
        })
      })
    ]
...
function Md() {
  return j.jsxs("div", {
    className: "flex p-10 justify-center items-center flex-col",
    children: [
      j.jsx("img", {
        alt: "not-data",
        src: "../../assets/logo/empty-box.png",
        className: "w-20 h-20"
      }),
      j.jsx("p", { children: "No Data" })
    ]
  });
}
function Ql(e) {
  return j.jsxs("div", {
    className: "w-54 bg-slate-200 min-h-fit rounded-sm p-1",
    children: [
      j.jsx("div", {
...
const Dd = () =>
    j.jsxs("div", {
      className:
        "h-full min-h-screen w-60 p-2 border-gray-300 border-2 flex flex-col gap-y-2 ",
      children: [
        j.jsx(Ql, { title: "Projects" }),
        j.jsx(Ql, { title: "Channels" }),
        j.jsx(Ql, { title: "Chat Rooms" })
      ]
    }),
  yr = () =>
    j.jsxs("div", {
      className:
        "h-full min-h-screen w-60 p-2 border-gray-300 border-2 flex flex-col gap-y-2",
      children: [
        j.jsx("div", { className: "bg-lime-400 p-2", children: "Open" }),
        j.jsx("div", { className: "" })
      ]
    });
function Id() {
  return j.jsxs(j.Fragment, {
    children: [
      j.jsx(Od, {}),
      j.jsxs("div", {
        className: "flex gap-y-3 gap-x-3",
        children: [
          j.jsx(Dd, {}),
          j.jsx(yr, {}),
          j.jsx(yr, {}),
...
Kl.createRoot(document.getElementById("root")).render(
  j.jsx(kc.StrictMode, { children: j.jsx(Id, {}) })
);
